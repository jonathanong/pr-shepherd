...
- Compact, read-only aggregate polling for explicit same-repository PR lists and complete native GitHub stacks, with independent one-PR commands for explicit sets and bottom-to-top guidance plus stale ancestry detection for stacks.
