...
- Compact, read-only aggregate polling for explicit same-repository PR lists and complete native GitHub stacks, with bottom-to-top stack ordering and per-row one-PR commands.
