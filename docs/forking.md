...
The monitor prompt includes `#pr-shepherd-loop:pr=<N>:` so agents and logs can identify the PR being monitored. Change this string in `skills/monitor/SKILL.md` to avoid conflicts with other installations:
