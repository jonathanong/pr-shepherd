...
7. `[FIX_CODE]` requires a push after conflict resolution. Commit and push the resolved changes, then iterate again once the remote PR head reflects your push.
