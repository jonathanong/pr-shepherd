...
- base: `main`
- apply review: `pr-shepherd apply review https://github.com/owner/repo/pull/42 --reply-thread-ids PRRT_human,PRRT_bot,PRRT_bracket_bot --message "$DISMISS_MESSAGE" --resolve-thread-ids PRRT_bot,PRRT_bracket_bot --require-sha "$HEAD_SHA"`
