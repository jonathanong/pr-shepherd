...
- base: `main`
- apply review: `pr-shepherd apply review https://github.com/owner/repo/pull/42 --reply-thread-ids PRRT_with_denied_approval --message "$DISMISS_MESSAGE" --require-sha "$HEAD_SHA"`
