...
1. Automatic mark-ready is disabled, so marking PR #421 ready for review is your step. Run `pr-shepherd https://github.com/owner/repo/pull/421 --timeout 1s --debounce 0s --no-auto-mark-ready` first. If it returns `[WAIT]`, run `gh pr ready 421 -R owner/repo`; otherwise complete its instructions and leave PR #421 in draft this round.
