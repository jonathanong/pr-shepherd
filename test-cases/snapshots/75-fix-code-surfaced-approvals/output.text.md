...
### [threadId=PRRT_with_approval](https://github.com/owner/repo/pull/42#discussion_r10) — `src/index.ts:10` (@reviewer · User)

> One more nit before this merges.

## Approvals (surfaced — not minimized)

### `reviewId=PRR_bot_approval` (@coderabbitai · Bot)
...
- base: `main`
- apply review: `pr-shepherd apply review https://github.com/owner/repo/pull/42 --reply-thread-ids PRRT_with_approval --message "$DISMISS_MESSAGE" --require-sha "$HEAD_SHA"`
