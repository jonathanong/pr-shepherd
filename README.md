...
4. If you changed code, commit any remaining changes before review mutations. Shepherd does not recommend a push because it cannot verify the local Git credential's authorization.
