...
| `checks.timeoutPatterns`             | see [docs/configuration.md](docs/configuration.md) | Log patterns that classify a failure as `timeout`                                |
| `checks.infraPatterns`               | see [docs/configuration.md](docs/configuration.md) | Log patterns that classify a failure as `infrastructure`                         |
