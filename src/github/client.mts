 ...
 *
 * All GitHub API interaction routes through this module so tests can
 * substitute a fake implementation without touching the network.
 */
...
export interface GhOptions {
  /** If true, retry the call without the sandbox restriction. Set by tests to skip. */
